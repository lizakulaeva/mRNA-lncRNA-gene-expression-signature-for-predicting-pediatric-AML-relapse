---
title: "TARGET_Rmarkdown"
author: "Elizaveta Kulaeva"
date: "10 08 2022"
...
#### Get clinical data from [public repository of TARGET Clinical Data](https://target-data.nci.nih.gov/Public/AML/clinical/harmonized/):
...
#### Get annotation file from [Biomart download](https://drive.google.com/file/d/10er_0UAxsAZ5rJBJZ4x8XS3TYdJ4t4sR/view?usp=sharing)
...
grid.arrange(l1, l2,
             ...
             top = textGrob('lncRNA volcano',
                            ...
                            gp = gpar(fontsize = 32)))
```
![lncrna_plot](lncRNA_volcano.png)
